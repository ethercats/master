...
contract fetchVRFNumber is VRFConsumerBase {
    //Polygon Mainnet
    //The contract will generate a 12 digit random number for ipfs://QmXxgXTg5WxcKiJyHzUv6Gg3ThjKdg7XrDAVwryD4EfXqk
    ...
    string public targetScript = "ipfs://QmXxgXTg5WxcKiJyHzUv6Gg3ThjKdg7XrDAVwryD4EfXqk";
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override coordinatorAllowed {
        ...
        //Take only the last 12 digits of the returned full length uint256 so the metadata script's PRNG won't break. 
