//These are the token IDs that were minted in the Founders Series. We can use this list to trim the output results since we no longer need to enumerate every possible.
...
var filePathMetadata = "../nfts/founders-series/metadata-json/"
